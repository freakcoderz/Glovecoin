...
unsigned int nTargetSpacing = 1 * 180;
...
const string strMessageGlovecoin = "Glovecoin Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Glovecoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Glovecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //block.GetHash() == 00000b52090d1fd6e3b0b7c50b596da464f8eab2ab4efd4c3d7f343e3b9c82b0
        //block.hashMerkleRoot == a3a08ccba7869b7812a3492c5431dd0b7dc482f6ce8b5b02d9c2c80120bf5e93
        //block.nTime =  1558068346
        //block.nNonce = 397296

        const char* pszTimestamp = "Glovecoin for world economy 2019";
        CTransaction txNew;
        txNew.nTime = 1558068346;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 397296 : 0;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0xa3a08ccba7869b7812a3492c5431dd0b7dc482f6ce8b5b02d9c2c80120bf5e93"));
...
unsigned char pchMessageStart[4] = { 0xca, 0xc4, 0xba, 0xa4 };
